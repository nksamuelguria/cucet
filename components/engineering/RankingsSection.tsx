      ...
      <div className="container px-188 px-1399 h-full!">
        <div className="row h-full! items-end!">
          <div className="col-md-5 hidden! md:block!">
            <img loading="lazy" decoding="async" src="/engineering/imgs-new/rank-inset.webp" width="554" alt="Rankings Inset" className="rankInset" />
          </div>
          <div className="col-md-7 h-full!">
            <div className="row h-49 align-items-center">
              <div className="col-sm-6">
                <img loading="lazy" decoding="async" className="nirf-image" src="/engineering/imgs-new/nirf-ranking.webp" alt="NIRF Rankings"
                  width="294" />
              </div>
              <div className="col-sm-6">
                <img loading="lazy" decoding="async" className="qs-image" src="/engineering/imgs-new/qs-rank-by-subject-engineering-banner.webp"
                  alt="QS World University Rankings" width="360" />
              </div>
            </div>
            <div className="row h-51 items-start!">
              <div className="col-sm-6 abet-block">
                <img loading="lazy" decoding="async" className="abet-logo mr-4!" src="/engineering/imgs-new/abet-logo-engineering_white.webp"
                  alt="ABET Rankings" />
              ...
              <div className="col-sm-6 abet-block">
                <img loading="lazy" decoding="async" className="abet-logo mr-4!"
